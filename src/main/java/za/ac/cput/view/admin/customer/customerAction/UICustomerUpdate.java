...
public class UICustomerUpdate extends JFrame implements ActionListener {
    ...
    private JTextField txtFName, txtLName, txtEmail, txtPassword, txtUsername, txtContactNumber;
    private Client client;
    private int index;

    public UICustomerUpdate(int x, int y, String id) {
        super("❣ Customer Update Menu");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        setLocation(x, y);
        client = CustomerFunctionality.getClientById(id);
        ...
        lblTitle = new JLabel("UPDATE CUSTOMER", SwingConstants.LEFT);
        ...
        txtFName.setText(client.getName());
        ...
        txtLName.setText(client.getSurname());
        ...
        txtContactNumber.setText(client.getContactNumber());
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("UPDATE")) {
            if(txtFName.getText().equals("") || txtLName.getText().equals("") || txtContactNumber.getText().equals("")) {
                ...
                Client updateClient = new Client.Builder().copy(client)
                        .setName(fName)
                        .setSurname(lName)
                        .setContactNumber(contactNumber)
                        .build();
                CustomerFunctionality.updateCustomer(updateClient);
                UICustomer.refresh();
                dispose();
            }
