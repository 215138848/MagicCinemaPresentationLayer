package za.ac.cput.view.admin.rental.equipmentActions;
...
public class UIRentalReturn extends JFrame implements ActionListener {
    ...
    public UIRentalReturn(int x, int y, String selectedId) {
        super("❣ Rental Return Menu");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        setLocation(x, y);
        Equipment equipment = EquipmentFunctionality.getEquipmentById(selectedId);
        ...
        cbEquipmentCategory.setSelectedItem(equipment.getGearCategory());
        ...
        txtSubCategory.setText(equipment.getGearSubCategory());
        ...
        txtMake.setText(equipment.getMake());
        ...
        txtCostPerUnit.setText(String.valueOf(equipment.getRentalPrice()));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("SAVE")) {
            if(txtEquipmentId.getText().equals("") || cbEquipmentCategory.getSelectedIndex() == 0 || txtSubCategory.getText().equals("")
                ...
                EquipmentFunctionality.updateEquipment(equipmentId, equipmentCategory, equipmentSubCategory, make, model, costPerUnit, quantity);
                UIEquipment.refresh();
                dispose();
            }
