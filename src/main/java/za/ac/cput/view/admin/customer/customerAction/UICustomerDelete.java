...
public class UICustomerDelete extends JFrame implements ActionListener {
    private JLabel lblTitle;
    private JTextField txtFName, txtLName, txtEmail, txtPassword;
    private JComboBox cbAccountType;
    private String id;

    public UICustomerDelete(int x, int y, String id) {
        super("❣ Customer Delete Menu");
        this.id = id;
        ...
        lblTitle = new JLabel("DELETE THIS CUSTOMER?", SwingConstants.LEFT);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("YES")) {
            CustomerFunctionality.deleteCustomer(id);
            UICustomer.refresh();
            dispose();
