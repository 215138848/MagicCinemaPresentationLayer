...
public class UIEmployeeDelete extends JFrame implements ActionListener {
    ...
    public UIEmployeeDelete(int x, int y, String id) {
        super("❣ Employee Delete Menu");
        this.id = id;
        ...
        lblTitle = new JLabel("DELETE THIS EMPLOYEE?", SwingConstants.LEFT);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("YES")) {
            EmployeeFunctionality.deleteEmployee(id);
            UIEmployee.refresh();
            dispose();
